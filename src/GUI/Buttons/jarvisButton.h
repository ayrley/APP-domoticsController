#ifndef __JARVIS_BUTTON_H
#define __JARVIS_BUTTON_H
...
class JarvisButton : public nanogui::Widget {
public:
	explicit JarvisButton(nanogui::Widget *parent, const std::string &label,

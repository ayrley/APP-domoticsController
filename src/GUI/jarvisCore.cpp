#include "jarvisCore.h"

#include <cmath>

#include <nanogui/opengl.h>

JarvisCore::JarvisCore(nanogui::Widget *parent, const std::string &caption)
    : nanogui::Widget(parent), m_caption(caption) {}

void JarvisCore::draw(NVGcontext *ctx) {
	Widget::draw(ctx);
